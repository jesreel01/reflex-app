...
import { Colors, GridListItemProps, GridView } from "react-native-ui-lib";
  ...
  return (
    <View className="flex flex-wrap">
        ...
        <View className="w-1/2 aspect-square">
          <Image
            source={{ uri: "https://plus.unsplash.com/premium_photo-1732730224379-8a0805fa27ef?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" }}
            className="w-full h-full rounded-2xl bg-red-500"
            resizeMode="cover"
          />
        </View>
        <View className="w-1/2 aspect-square">
        ...
        <View className="w-full aspect-[2/1]">
          <Image
            source={{ uri: '/placeholder.svg?height=400&width=800' }}
